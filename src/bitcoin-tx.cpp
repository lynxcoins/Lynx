...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s lynx-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lynx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lynx transaction") + "\n" +
              "  lynx-tx [options] -create [commands]   " + _("Create hex-encoded lynx transaction") + "\n" +
              "\n";
