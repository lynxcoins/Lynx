...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacingV1 = 30;
        consensus.nPowTargetSpacingV2 = 60;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 6048; // 75% of 8064
        consensus.nMinerConfirmationWindow = 240; // nPowTargetTimespan / nPowTargetSpacingV2 * 4
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 1 * 60 * 60; // // KittehCoin: retarget every 1 hours
        consensus.nPowTargetSpacingV1 = 60;
        consensus.nPowTargetSpacingV2 = 60;
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8f09f45a7937ab424032c1b366cff9066961e407a62805a359f99f652a0f820d"));
